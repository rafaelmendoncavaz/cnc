//==================================================================
// Função Lagrange 3º Caso
// Objetivo: Aproximar a 1ª derivada usando o polinômio de Lagrange (3º Caso)
// Fórmula assimétrica regressiva de ordem 2 (três pontos para trás)
//==================================================================
// Entradas:
...
function Lagrange_3o_Caso(X, Y, k, derivada_1a_exata)
    ...
    printf("\n/////////////////////////////////////////////////////////\n")
    printf(" Cálculo da derivada de 1a ordem em x = %g pelo Método de Lagrange - 3º Caso (regressivo):\n", X(k))
