...
//==================================================================
caminho = get_absolute_file_path("b-q6.sce")
...
// Entrada de dados
//==================================================================
X = [260, 280, 300, 320, 240]
Y = [32.448000, 37.632000, 43.200000, 49.152000, 55.488000]
k = 3 	// indice do ponto a ser avaliado
x = 300 // valor a ser calculado

// Calcular derivadas exatas: https://www.derivative-calculator.net/
// Derivadas exatas no ponto de interesse da função = sqrt(x^3+9)

// f(t)
deff('y = f(x)', 'y = 0.00048 * x^2')
// f'(t)
deff('y = f1(x)', 'y = (3 * x) / 3125')
// f''(t)
deff('y = f2(x)', 'y = 3 / 3125')
// f'''(t)
deff('y = f3(x)', 'y = 0')
// f''''(t)
deff('y = f4(x)', 'y = 0')

derivada_1a_exata = f1(x) // 0.288000
derivada_2a_exata = f2(x) // 0.000960
derivada_3a_exata = f3(x) // 0
derivada_4a_exata = f4(x) // 0
