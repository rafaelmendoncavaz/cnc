...
//==================================================================
caminho = get_absolute_file_path("b-q8.sce")
...
//==================================================================
X = [40, 42, 44, 46, 48]
Y = [8.928571, 8.680556, 8.445946, 8.223684, 8.012821]
k = 3 	// indice do ponto a ser avaliado
x = 44 // valor a ser calculado

// Calcular derivadas exatas: https://www.derivative-calculator.net/
// Derivadas exatas no ponto de interesse da função = sqrt(x^3+9)

// f(t)
deff('y = f(x)', 'y = 625 / (x + 30)')
// f'(t)
deff('y = f1(x)', 'y = -625 / (x + 30)^2')
// f''(t)
deff('y = f2(x)', 'y = 1250 / (x + 30)^3')
// f'''(t)
deff('y = f3(x)', 'y = -3750 / (x + 30)^4')
// f''''(t)
deff('y = f4(x)', 'y = 15000 / (x + 30)^5')

derivada_1a_exata = f1(x) // -0.11413
derivada_2a_exata = f2(x) // 0.003085
derivada_3a_exata = f3(x) // -0.00013
derivada_4a_exata = f4(x) // 0.0000068
