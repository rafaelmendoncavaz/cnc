...
//==================================================================
caminho = get_absolute_file_path("b-q4.sce")
...
deff('y = f1(x)', 'y = 1 / (x + 1)')
// f''(t)
deff('y = f2(x)', 'y = -1 / (x + 1)^2')
// f'''(t)
deff('y = f3(x)', 'y = 2 / (x + 1)^3')
// f''''(t)
deff('y = f4(x)', 'y = -6 / (x + 1)^4')

derivada_1a_exata = f1(x) // 0.333333
derivada_2a_exata = f2(x) // -0.11111
derivada_3a_exata = f3(x) // 0.074074
derivada_4a_exata = f4(x) // -0.07407
