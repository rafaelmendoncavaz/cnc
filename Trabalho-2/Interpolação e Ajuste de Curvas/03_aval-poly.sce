// Função: Avaliar Polinômio
// Objetivo: Avaliar um polinômio em um ou mais pontos e opcionalmente, calcular
// o erro percentual relativo se o valor de referência for fornecido e numérico
//--------------------------------------------------------
// Entradas:
